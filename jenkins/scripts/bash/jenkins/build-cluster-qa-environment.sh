...
template_filename='/var/lib/jenkins/rpcsqa/chef-cookbooks/environments/templates/cluster-qa.json'
environment_filename='/var/lib/jenkins/rpcsqa/chef-cookbooks/environments/cluster-qa.json'
