...
template_filename='/var/lib/jenkins/rpcsqa/chef-cookbooks/environments/templates/opencenter.json'
environment_filename='/var/lib/jenkins/rpcsqa/chef-cookbooks/environments/opencenter.json'
